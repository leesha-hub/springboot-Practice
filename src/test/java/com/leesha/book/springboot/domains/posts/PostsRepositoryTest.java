package com.leesha.book.springboot.domains.posts;
...
public class PostsRepositoryTest {
    ...
    public void BaseTimeEntity_등록() {
        ...
        //when
        List<Posts> postsList = postsRepository.findAll();
        System.out.println(">>>>>>>>> postsRepository=" + postsRepository.findAll());

        //then
        Posts posts = postsList.get(0);
        System.out.println(">>>>>>>>> posts=" + postsList.get(0));
